...
public class AsistenView extends JPanel {
    ...
    private final JTextField txtNim = new JTextField(20);
    ...
    public AsistenView() {
        ...
        form.setBorder(BorderFactory.createTitledBorder("Form Asisten"));
