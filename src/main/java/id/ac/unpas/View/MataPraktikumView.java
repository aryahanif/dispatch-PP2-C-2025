...
public class MataPraktikumView extends JPanel {
    ...
    public MataPraktikumView() {
        ...
        form.setBorder(BorderFactory.createTitledBorder("Form Mata Praktikum"));
        ...
        DefaultTableModel model = new DefaultTableModel(new Object[] { "ID", "Kode", "Nama" }, 0) {
            @Override
